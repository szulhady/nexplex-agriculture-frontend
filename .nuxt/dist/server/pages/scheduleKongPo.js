...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/scheduleKongPo.vue?vue&type=template&id=0f96f0c2&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('section',[_c('PageTitle',{attrs:{"title":"SCHEDULE"}}),_vm._ssrNode(" "),_c('v-card',[_c('v-card-title',[_vm._v("\n      Set schedule for fertigation\n    ")]),_vm._v(" "),_c('v-row',[_c('v-col',{staticClass:"pl-8 col-lg-3",staticStyle:{"display":"flex","flex-direction":"column","justify-content":"center","align-items":"center"},attrs:{"cols":"12"}},[_c('div',[_c('h4',[_vm._v("Select Date")]),_vm._v(" "),_c('h5',[_vm._v("Can be a day or range of days")]),_vm._v(" "),_c('span',[_c('vc-date-picker',{attrs:{"min-date":_vm.today,"disabled-dates":_vm.disabled,"is-range":""},model:{value:(_vm.range),callback:function ($$v) {_vm.range=$$v},expression:"range"}})],1)]),_vm._v(" "),_c('div',[_c('v-btn',{staticClass:"mt-5",on:{"click":_vm.sendSchedule}},[_vm._v("\n            SET SCHEDULE\n          ")])],1)]),_vm._v(" "),_c('v-col',{staticClass:"mx-auto col-lg-9",attrs:{"cols":"12"}},[_c('v-row',[_c('v-col',{staticClass:"ml-10 ml-lg-0"},[_c('h4',[_vm._v("\n              Please fill first option first, then fill other options if\n              needed. Options for 7am and 1pm are not available due to\n              nutrient preparation process ongoing.\n            ")])])],1),_vm._v(" "),_c('v-row',[_c('v-col',{staticClass:"userInput col-sm-6",attrs:{"cols":"12"}},[_c('div',{staticClass:"mr-8"},[_c('label',[_vm._v("1)")]),_vm._v(" "),_c('vue-timepicker',{attrs:{"format":"HH:mm","hour-range":[
                  [0, 6],
                  [8, 12],
                  [14, 23]
                ],"hide-disabled-hours":""},model:{value:(_vm.yourStringTimeValue1),callback:function ($$v) {_vm.yourStringTimeValue1=$$v},expression:"yourStringTimeValue1"}})],1),_vm._v(" "),_c('div',{},[_c('v-text-field',{staticClass:"short",attrs:{"label":"Duration (min)","rules":_vm.rules,"type":"number"},model:{value:(_vm.duration1),callback:function ($$v) {_vm.duration1=$$v},expression:"duration1"}})],1)]),_vm._v(" "),_c('v-col',{staticClass:"userInput col-sm-6",attrs:{"cols":"12"}},[_c('div',{staticClass:"mr-8"},[_c('label',[_vm._v("2)")]),_vm._v(" "),_c('vue-timepicker',{attrs:{"format":"HH:mm","hour-range":[
                  [0, 6],
                  [8, 12],
                  [14, 23]
                ],"hide-disabled-hours":""},model:{value:(_vm.yourStringTimeValue2),callback:function ($$v) {_vm.yourStringTimeValue2=$$v},expression:"yourStringTimeValue2"}})],1),_vm._v(" "),_c('div',{},[_c('v-text-field',{staticClass:"short",attrs:{"label":"Duration (min)","rules":_vm.rules,"type":"number"},model:{value:(_vm.duration2),callback:function ($$v) {_vm.duration2=$$v},expression:"duration2"}})],1)]),_vm._v(" "),_c('v-col',{staticClass:"userInput col-sm-6",attrs:{"cols":"12"}},[_c('div',{staticClass:"mr-8"},[_c('label',[_vm._v("3)")]),_vm._v(" "),_c('vue-timepicker',{attrs:{"format":"HH:mm","hour-range":[
                  [0, 6],
                  [8, 12],
                  [14, 23]
                ],"hide-disabled-hours":""},model:{value:(_vm.yourStringTimeValue3),callback:function ($$v) {_vm.yourStringTimeValue3=$$v},expression:"yourStringTimeValue3"}})],1),_vm._v(" "),_c('div',{},[_c('v-text-field',{staticClass:"short",attrs:{"label":"Duration (min)","rules":_vm.rules,"type":"number"},model:{value:(_vm.duration3),callback:function ($$v) {_vm.duration3=$$v},expression:"duration3"}})],1)]),_vm._v(" "),_c('v-col',{staticClass:"userInput col-sm-6",attrs:{"cols":"12"}},[_c('div',{staticClass:"mr-8"},[_c('label',[_vm._v("4)")]),_vm._v(" "),_c('vue-timepicker',{attrs:{"format":"HH:mm","hour-range":[
                  [0, 6],
                  [8, 12],
                  [14, 23]
                ],"hide-disabled-hours":""},model:{value:(_vm.yourStringTimeValue4),callback:function ($$v) {_vm.yourStringTimeValue4=$$v},expression:"yourStringTimeValue4"}})],1),_vm._v(" "),_c('div',{},[_c('v-text-field',{staticClass:"short",attrs:{"label":"Duration (min)","rules":_vm.rules,"type":"number"},model:{value:(_vm.duration4),callback:function ($$v) {_vm.duration4=$$v},expression:"duration4"}})],1)]),_vm._v(" "),_c('v-col',{staticClass:"userInput col-sm-6",attrs:{"cols":"12"}},[_c('div',{staticClass:"mr-8"},[_c('label',[_vm._v("5)")]),_vm._v(" "),_c('vue-timepicker',{attrs:{"format":"HH:mm","hour-range":[
                  [0, 6],
                  [8, 12],
                  [14, 23]
                ],"hide-disabled-hours":""},model:{value:(_vm.yourStringTimeValue5),callback:function ($$v) {_vm.yourStringTimeValue5=$$v},expression:"yourStringTimeValue5"}})],1),_vm._v(" "),_c('div',{},[_c('v-text-field',{staticClass:"short",attrs:{"label":"Duration (min)","rules":_vm.rules,"type":"number"},model:{value:(_vm.duration5),callback:function ($$v) {_vm.duration5=$$v},expression:"duration5"}})],1)]),_vm._v(" "),_c('v-col',{staticClass:"userInput col-sm-6",attrs:{"cols":"12"}},[_c('div',{staticClass:"mr-8"},[_c('label',[_vm._v("6)")]),_vm._v(" "),_c('vue-timepicker',{attrs:{"format":"HH:mm","hour-range":[
                  [0, 6],
                  [8, 12],
                  [14, 23]
                ],"hide-disabled-hours":""},model:{value:(_vm.yourStringTimeValue6),callback:function ($$v) {_vm.yourStringTimeValue6=$$v},expression:"yourStringTimeValue6"}})],1),_vm._v(" "),_c('div',{},[_c('v-text-field',{staticClass:"short",attrs:{"label":"Duration (min)","rules":_vm.rules,"type":"number"},model:{value:(_vm.duration6),callback:function ($$v) {_vm.duration6=$$v},expression:"duration6"}})],1)]),_vm._v(" "),_c('v-col',{staticClass:"userInput col-sm-6",attrs:{"cols":"12"}},[_c('div',{staticClass:"mr-8"},[_c('label',[_vm._v("7)")]),_vm._v(" "),_c('vue-timepicker',{attrs:{"format":"HH:mm","hour-range":[
                  [0, 6],
                  [8, 12],
                  [14, 23]
                ],"hide-disabled-hours":""},model:{value:(_vm.yourStringTimeValue7),callback:function ($$v) {_vm.yourStringTimeValue7=$$v},expression:"yourStringTimeValue7"}})],1),_vm._v(" "),_c('div',{},[_c('v-text-field',{staticClass:"short",attrs:{"label":"Duration (min)","rules":_vm.rules,"type":"number"},model:{value:(_vm.duration7),callback:function ($$v) {_vm.duration7=$$v},expression:"duration7"}})],1)]),_vm._v(" "),_c('v-col',{staticClass:"userInput col-sm-6",attrs:{"cols":"12"}},[_c('div',{staticClass:"mr-8"},[_c('label',[_vm._v("8)")]),_vm._v(" "),_c('vue-timepicker',{attrs:{"format":"HH:mm","hour-range":[
                  [0, 6],
                  [8, 12],
                  [14, 23]
                ],"hide-disabled-hours":""},model:{value:(_vm.yourStringTimeValue8),callback:function ($$v) {_vm.yourStringTimeValue8=$$v},expression:"yourStringTimeValue8"}})],1),_vm._v(" "),_c('div',{},[_c('v-text-field',{staticClass:"short",attrs:{"label":"Duration (min)","rules":_vm.rules,"type":"number"},model:{value:(_vm.duration8),callback:function ($$v) {_vm.duration8=$$v},expression:"duration8"}})],1)]),_vm._v(" "),_c('v-col',{staticClass:"userInput col-sm-6",attrs:{"cols":"12"}},[_c('div',{staticClass:"mr-8"},[_c('label',[_vm._v("9)")]),_vm._v(" "),_c('vue-timepicker',{attrs:{"format":"HH:mm","hour-range":[
                  [0, 6],
                  [8, 12],
                  [14, 23]
                ],"hide-disabled-hours":""},model:{value:(_vm.yourStringTimeValue9),callback:function ($$v) {_vm.yourStringTimeValue9=$$v},expression:"yourStringTimeValue9"}})],1),_vm._v(" "),_c('div',{},[_c('v-text-field',{staticClass:"short",attrs:{"label":"Duration (min)","rules":_vm.rules,"type":"number"},model:{value:(_vm.duration9),callback:function ($$v) {_vm.duration9=$$v},expression:"duration9"}})],1)]),_vm._v(" "),_c('v-col',{staticClass:"userInput col-sm-6",attrs:{"cols":"12"}},[_c('div',{staticClass:"mr-8"},[_c('label',[_vm._v("10)")]),_vm._v(" "),_c('vue-timepicker',{attrs:{"format":"HH:mm","hour-range":[
                  [0, 6],
                  [8, 12],
                  [14, 23]
                ],"hide-disabled-hours":""},model:{value:(_vm.yourStringTimeValue10),callback:function ($$v) {_vm.yourStringTimeValue10=$$v},expression:"yourStringTimeValue10"}})],1),_vm._v(" "),_c('div',{},[_c('v-text-field',{staticClass:"short",attrs:{"label":"Duration (min)","rules":_vm.rules,"type":"number"},model:{value:(_vm.duration10),callback:function ($$v) {_vm.duration10=$$v},expression:"duration10"}})],1)])],1)],1)],1)],1)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/scheduleKongPo.vue?vue&type=template&id=0f96f0c2&
...
/* harmony default export */ var scheduleKongPovue_type_script_lang_js_ = ({
  ...
  methods: {
    getScheduleIpah1: function () {
      this.$axios.$get("http://139.59.109.48/api/schedule/kongPo").then(response => {
        console.log(response);
        response.forEach(i => this.disabled.push(external_moment_default()(i).format("YYYY-MM-DD")));
      }).catch(error => {
        console.log(error);
    ...
    sendScheduleIpah1: function (date, time, duration) {
      this.$axios.$post("http://139.59.109.48/api/setSchedule/kongPo", {
        date: date,
        time: time,
        duration: duration
      }).then(response => {
...
installComponents_default()(component, {VBtn: VBtn["a" /* default */],VCard: VCard["a" /* default */],VCardTitle: components_VCard["b" /* VCardTitle */],VCol: VCol["a" /* default */],VRow: VRow["a" /* default */],VTextField: VTextField["a" /* default */]})
