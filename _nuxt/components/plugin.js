...
const components = {
  ...
  DetailOperationInformation: () => import('../..\\components\\detail\\operationInformation.vue' /* webpackChunkName: "components/detail-operation-information" */).then(c => wrapFunctional(c.default || c)),
  DetailReport: () => import('../..\\components\\detail\\report.vue' /* webpackChunkName: "components/detail-report" */).then(c => wrapFunctional(c.default || c)),
  DetailUsers: () => import('../..\\components\\detail\\users.vue' /* webpackChunkName: "components/detail-users" */).then(c => wrapFunctional(c.default || c)),
  DetailYieldCropInformation: () => import('../..\\components\\detail\\yieldCropInformation.vue' /* webpackChunkName: "components/detail-yield-crop-information" */).then(c => wrapFunctional(c.default || c)),
  ...
  ScheduleTableScheduleNutrient: () => import('../..\\components\\Schedule\\TableScheduleNutrient.vue' /* webpackChunkName: "components/schedule-table-schedule-nutrient" */).then(c => wrapFunctional(c.default || c)),
  ...
  TrendCardStationTrendKongPo: () => import('../..\\components\\Trend\\CardStationTrendKongPo.vue' /* webpackChunkName: "components/trend-card-station-trend-kong-po" */).then(c => wrapFunctional(c.default || c)),
